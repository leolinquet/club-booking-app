            ...
            <div className="ml-10 space-x-8 lg:block">
              <div className="flex items-center space-x-6">
                ...
                <a
                  ...
                  className="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 cursor-pointer"
                >
                  Get Started
                </a>
              </div>
              ...
              <div className="lg:w-1/2">
                ...
                <div className="mt-8 flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-3">
                  <a
                    ...
                    className="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 md:py-4 md:text-lg md:px-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow cursor-pointer"
                  >
                    Get Started
                  ...
                  <a
                    ...
                    className="flex items-center justify-center px-8 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 cursor-pointer"
                  >
