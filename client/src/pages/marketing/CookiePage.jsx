            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    Enable social sharing and help us measure campaign effectiveness.
                  </p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              ...
              <div className="space-y-4 text-left max-w-md mx-auto">
                <div>
                  ...
                  <p className="text-gray-600">privacy@clubbooking.app</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">+1 267 824 1391</p>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-500">
                  ...
                  we'll notify you by updating the "Last updated" date at the top of this page.
                </p>
              </div>
            </div>
          </div>
